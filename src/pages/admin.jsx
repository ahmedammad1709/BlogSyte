...
const Admin = () => {
  ...
  const fetchStats = async () => {
    try {
      ...
      const response = await fetch(config.API_ENDPOINTS.ADMIN_STATS);
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      const response = await fetch(config.API_ENDPOINTS.ADMIN_USERS);
      const data = await response.json();
  ...
  const fetchBlogs = async () => {
    ...
    try {
      ...
      const response = await fetch(config.API_ENDPOINTS.ADMIN_BLOGS);
      const data = await response.json();
